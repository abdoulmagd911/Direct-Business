...
**Built `TravelAgencies_MASTER_v3.xlsx`: 6,131 rows** (handed over in chat 2026-08-13; not
kept in this public repo — real company data never goes in it). The Jul 23 file
...
this environment; it was handed over in-chat (2026-08-13 backup zip).
