...
const PEOPLE = [
  ['admin',       'test@directksa.com',                'Dq7nTest-2026-Riyadh'],
  ['manager',     'osharafi@direct-visa.net',          'Direct-2026-Othman!'],
  ['bd',          'raad.elkhair@directksa.com',        'Direct-2026-Raad!'],
  ['operations',  'kareem.medhat@directksa.com',       'Direct-2026-Kareem!'],
  ['team_member', 'assem.alsweed@directksa.com',       'Direct-2026-Assem!'],
  ['viewer',      'mohammed.altuwaijri@directksa.com', 'Direct-2026-Mohammed!'],
];
...
const EXPECT = {
  ...
  bd:          { businesses: 1, activities: 1, app_offers: 1, app_requests: 1, app_bookings: 1, finance_invoices: 0, finance_expenses: 0, app_settings: 0, promo_codes: 1 },
  operations:  { businesses: 0, activities: 1, app_offers: 0, app_requests: 1, app_bookings: 1, finance_invoices: 0, finance_expenses: 0, app_settings: 0, promo_codes: 0 },
  team_member: { businesses: 1, activities: 1, app_offers: 1, app_requests: 1, app_bookings: 1, finance_invoices: 0, finance_expenses: 0, app_settings: 0, promo_codes: 0 },
  viewer:      { businesses: 0, activities: 0, app_offers: 0, app_requests: 0, app_bookings: 0, finance_invoices: 0, finance_expenses: 0, app_settings: 0, promo_codes: 0 },
};
...
const admTok = await token('test@directksa.com', 'Dq7nTest-2026-Riyadh');
...
for (const [role, email, pw] of PEOPLE) {
  ...
  got.app_offers       = await ins(t, 'app_offers', { id: 'rlsprobe-off-' + role, data: { id: 'rlsprobe-off-' + role, ref: 'RLS' } });
  got.app_requests     = await ins(t, 'app_requests', { id: 'rlsprobe-req-' + role, data: { id: 'rlsprobe-req-' + role, client: 'RLS' } });
  got.app_bookings     = await ins(t, 'app_bookings', { id: 'rlsprobe-bk-' + role, data: { id: 'rlsprobe-bk-' + role, ref: 'RLS' } });
