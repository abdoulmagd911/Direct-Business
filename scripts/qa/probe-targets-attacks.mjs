...
async function main() {
  ...
  await p.route(__pred('vkxoeeoauexyfpzqufqd.supabase.co/rest/v1/finance_targets'), async (route) => {
  ...
  await p.unroute(__pred('vkxoeeoauexyfpzqufqd.supabase.co/rest/v1/finance_targets'));
