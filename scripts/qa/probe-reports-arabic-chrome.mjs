...
const checks = [
  ['EN objectives card still says Target / Actual / INITIATIVES', EN_OBJ.every((s) => enObj.includes(s))],
  ...
  ['AR objectives card: Arabic chrome present, English chrome gone', AR_OBJ.every((s) => arObj.includes(s)) && !/Actual:|INITIATIVES|no KPI/.test(arObj)],
