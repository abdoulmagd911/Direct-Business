...
/* v39 — detail-card tidy (reversible):
   ...
   (The "hide the duplicate Lifetime billed row" step lived here too, until Key facts stopped
   printing a Lifetime billed row at all — money lives on Finance only, owner ruling 2026-08-21 —
   which made this block dead code. Removed 2026-08-21.)
   Nothing else deleted — remove this block (and the v33/v36 edits) to restore everything. */
(function(){try{
