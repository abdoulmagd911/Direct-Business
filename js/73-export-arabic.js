...
(function(){try{
  var LBL={
    ...
    // 2026-09-15 (fire #57, live): the "full details" files still carried raw keys on the Arabic
    // Leads (8), Clients (7), Airlines (27), Providers (10), Proposals (21) and SLA (1) exports
    tag:'الوسم', 'import':'الاستيراد', tag_note:'ملاحظة الوسم', sheet_note:'ملاحظة الجدول', sheet_owner:'مسؤول الجدول',
    sheet_stage:'مرحلة الجدول', classification:'التصنيف', sheet_owner_resolution:'تحديد مسؤول الجدول', invoices:'الفواتير',
    source_batch:'دفعة المصدر', serviceFit:'ملاءمة الخدمة',
    customer_raw_name:'اسم العميل كما ورد', record_type:'نوع السجل', collection_due_date:'تاريخ استحقاق التحصيل',
    exclusion_reason:'سبب الاستبعاد', created_at:'تاريخ الإنشاء', updated_at:'آخر تحديث', deleted_at:'تاريخ الحذف',
    line_no:'رقم السطر', branch:'الفرع', salesman:'مندوب المبيعات', project_tag:'وسم المشروع', items:'البنود',
    transaction_ref:'مرجع المعاملة', direct_uuid:'معرّف Direct',
    fleet:'الأسطول', ndcEnv:'بيئة NDC', noShow:'عدم الحضور', classes:'الدرجات', codeshare:'الرمز المشترك', corpPortal:'بوابة الشركات',
    ndcVersion:'إصدار NDC', syncHealth:'حالة المزامنة', ksaVerified:'موثّق في السعودية', lastSyncedAt:'آخر مزامنة',
    sourceSystem:'النظام المصدر', sourceRecordId:'معرّف السجل في المصدر', deepLinkToSource:'رابط المصدر', manual:'يدوي',
    frontend:'الواجهة', deeplinks:'الروابط المباشرة', nDCCallouts:'ملاحظات NDC', vendorEmailDomain:'نطاق بريد المورّد',
    casesObservedThisYear:'حالات هذا العام', opsNotes:'ملاحظات التشغيل', bspNotes:'ملاحظات BSP', commonIssues:'المشاكل الشائعة',
    escalationContact:'جهة التصعيد', recentReissuePolicyChanges:'تغييرات سياسة إعادة الإصدار', paymentMethodNotes:'ملاحظات طريقة الدفع',
    apiLast:'آخر فحص للربط', contact:'جهة الاتصال', connection:'الاتصال', verdictNote:'ملاحظة التقييم',
    cls:'الدرجة', dip:'DIP', ttl:'مهلة الإصدار', flight:'الرحلة', addFees:'رسوم إضافية', baggage:'الأمتعة', fileUrl:'رابط الملف',
    maxStay:'أقصى إقامة', minStay:'أدنى إقامة', remarks:'ملاحظات', cheapest:'الأرخص', fileName:'اسم الملف', filePath:'مسار الملف',
    lastIssue:'آخر موعد للإصدار', cancelAfter:'الإلغاء بعد', cancelBefore:'الإلغاء قبل', changesAfter:'التغيير بعد',
    changesBefore:'التغيير قبل', policyReason:'سبب السياسة', winLoseReason:'سبب الفوز أو الخسارة', rank:'الترتيب',
