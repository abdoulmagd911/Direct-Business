/* ===== v67: Brand Hub link in the nav =====
   Opens /brand/ (the internal brand hub: logos, colours, fonts) in a new tab.
   NOTE: renamed from v46 → v67 because the app already has a real v46 layer.
...
(function(){try{
  ...
  function inject(){
    ...
    var b=document.getElementById('v67BrandBtn');
  ...
  console.info('%c[v67] brand hub nav link loaded','color:#F47A1F;font-weight:700');
