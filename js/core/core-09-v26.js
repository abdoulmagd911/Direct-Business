...
(function v26_1Simplify(){
  ...
  var V26_EMPTY={
    ...
    bookings:{ic:'✈️',en:{t:'No bookings yet',sub:'Bookings appear here once they are created in the Direct system.'},ar:{t:'لا توجد حجوزات بعد',sub:'تظهر الحجوزات هنا بمجرد إنشائها داخل نظام Direct.'},onClick:function(){window.open('https://payments.directksa.com/en/admin','_blank');},btnEn:'Open Direct ↗',btnAr:'افتح Direct ↗'},
    invoices:{ic:'🧾',en:{t:'No invoices yet',sub:'Invoices appear here once they are created in Direct Payments.'},ar:{t:'لا توجد فواتير بعد',sub:'تظهر الفواتير هنا بمجرد إنشائها داخل Direct Payments.'},onClick:function(){window.open('https://payments.directksa.com/en/admin/invoices','_blank');},btnEn:'Open Direct Payments ↗',btnAr:'افتح Direct Payments ↗'},
    tickets:{ic:'🎟️',en:{t:'No tickets yet',sub:'Tickets appear here once they are issued in the Direct system.'},ar:{t:'لا توجد تذاكر بعد',sub:'تظهر التذاكر هنا بمجرد إصدارها داخل نظام Direct.'},onClick:function(){window.open('https://payments.directksa.com/en/admin','_blank');},btnEn:'Open Direct ↗',btnAr:'افتح Direct ↗'},
