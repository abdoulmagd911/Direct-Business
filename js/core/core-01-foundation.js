...
const SEED = {
  ...
  businesses:[
    {id:"b_mdd",name:"MDD — Smart Madad IT",nameAr:"مدد الذكية لتقنية المعلومات",segment:"Corporate / Events & Travel",category:"Anchor",isClient:true,totalSAR:6204662,invoices:41,contacts:[{name:"A. Alrashed",email:"A.alrashedd@mdd.sa",phone:"+966556613827"},{name:"Info",email:"Info@mdd.sa",phone:"+966561123333"},{name:"K. Almuqbil",email:"k.almuqbil@mdd.sa",phone:"+966507094179"}],entityType:"Corporate",legalName:"مدد الذكية لتقنية المعلومات",crVat:"3001xxxxxx00003",accountManager:"Abdelrahman",paymentTerms:"Pre-paid (wallet)",contractScope:"Air, hotel, transfer, conference",contractSLA:"Quote ≤4h · 24/7",airlineDeals:[{airline:"Saudia (SV)",code:"SV-CORP-DIRECT",discount:"7%",notes:"Min 200 seats/yr; excl. peak Umrah"},{airline:"Emirates (EK)",code:"EK-CORP-RUH",discount:"5%",notes:"J/Y only"}],pricing:[{service:"Flights",value:"+3% (min SAR 75)",notes:"per ticket"},{service:"Hotels",value:"+8%",notes:"on net"},{service:"Transfer",value:"+SAR 30",notes:""}],notes:"Largest active B2B account. CC-2."},
    {id:"b_takamol",name:"Takamol for Business Services",nameAr:"تكامل لخدمات الأعمال",segment:"Gov-linked services",category:"Anchor",isClient:true,totalSAR:13998876,invoices:41,contacts:[{name:"S. Alarjani",email:"S.Alarjani@Takamol.sa",phone:"+966583268887"},{name:"Acct",email:"",phone:"+966500141181"}],notes:"⚠ SVP/QVP — excluded from BD income."},
    {id:"b_maaden",name:"Maaden — Saudi Arabian Mining",nameAr:"شركة التعدين العربية السعودية معادن",segment:"Enterprise / Mining",category:"Anchor",isClient:true,totalSAR:704931,invoices:108,contacts:[{name:"Al Jabr",email:"AljabrA@maaden.com.sa",phone:""},{name:"Al Ansari",email:"alansarit@maaden.com.sa",phone:"+966553813245"}],notes:"108 invoices — clean up duplicate records."},
    {id:"b_qahtani",name:"Abdel Hadi Al-Qahtani & Sons",nameAr:"عبدالهادي عبدالله القحطاني وأولاده",segment:"Enterprise / Contracting",category:"Anchor",isClient:true,totalSAR:342449,invoices:16,contacts:[{name:"Al Shaloub",email:"ashalhoub@aqsse.com",phone:"+966502142671"}],notes:"Incl. Sinopec Shanghai scope. CC-17."},
    {id:"b_bta",name:"Booking & Ticket Agency",nameAr:"حجز وتذكرة",segment:"Travel sub-agent",category:"Anchor",isClient:true,totalSAR:139025,invoices:22,contacts:[{name:"A. Alhumaid",email:"a.alhumaid1993@gmail.com",phone:"+966568190299"},{name:"Desk",email:"",phone:"+966556093040"}],notes:"CC-3, post-paid 50k/5d."},
    {id:"b_benchmark",name:"Benchmark for Conferences",nameAr:"بنشمارك للمؤتمرات",segment:"MICE / Events",category:"Anchor",isClient:true,totalSAR:97535,invoices:13,contacts:[{name:"M. Dhafar",email:"mdhafarhg@gmail.com",phone:"+966539533149"}],notes:"CC-8."},
    {id:"b_maaal",name:"Maaal",nameAr:"مال",segment:"Media / Corporate",category:"Anchor",isClient:true,totalSAR:101400,invoices:4,contacts:[{name:"Accounts",email:"acc@maaal.com",phone:"+966555117178"}],notes:"CC-4, pre-paid."},
    {id:"b_ultimates",name:"The Ultimates (Faisal Aljarboa)",nameAr:"شركة فيصل عبدالله الجربوع",segment:"Corporate",category:"Anchor",isClient:true,totalSAR:59539,invoices:2,contacts:[{name:"Faisal Aljarboa",email:"Aljarboafaisal@gmail.com",phone:"+966500840840"}],notes:"CC-5."},
    {id:"b_kayan",name:"Kayan Orphans Charity",nameAr:"جمعية كيان للأيتام",segment:"Charity",category:"Anchor",isClient:true,totalSAR:1154200,invoices:3,contacts:[],notes:"CC-9. Incl. a 1,130,700 SAR package billed via B2C — verify same entity."},
    {id:"b_kaplan",name:"Kaplan",nameAr:"كابلان",segment:"Study-abroad school",category:"Vendor",isVendor:true,totalSAR:196117,invoices:5,contacts:[{name:"MENA B2B Support",email:"MENAB2B.Support@kaplan.com",phone:"+442074043080"}],notes:"Pays us commission."},
    {id:"b_bayswater",name:"Bayswater",nameAr:"بايزووتر",segment:"Study-abroad school",category:"Vendor",isVendor:true,totalSAR:135722,invoices:18,contacts:[{name:"Bookings",email:"bookings@bayswater.ac",phone:"+442072217259"}],notes:"Commission vendor, high frequency."},
    {id:"b_schools",name:"School network (ETC, EC, Malvern, ELC, CES, TLI, Sheffield, Kings, NCG)",nameAr:"شبكة معاهد الدراسة بالخارج",segment:"Study-abroad schools",category:"Vendor",isVendor:true,totalSAR:84360,invoices:23,contacts:[{name:"ETC",email:"invoices@etc-inter.net",phone:"+441202559044"},{name:"EC English",email:"MaysTayyem@ecenglish.com",phone:"+442045129248"}],notes:"Commission-paying schools — one vendor segment."},
    {id:"b_amadeus",name:"Amadeus Saudi Arabia",nameAr:"أماديوس السعودية",segment:"GDS partner",category:"Partner",isVendor:true,totalSAR:163675,invoices:5,contacts:[{name:"Office",email:"",phone:"+966122252371"}],notes:"GDS — settlement, not a sales lead."},
    {id:"b_bookingcom",name:"Booking.com",nameAr:"بوكينج",segment:"Hotel supplier partner",category:"Partner",isVendor:true,totalSAR:153786,invoices:8,contacts:[{name:"Data office",email:"dataprotectionoffice@booking.com",phone:""}],notes:"Supplier — not a sales lead."},
    {id:"b_mawani",name:"Mawani — Jeddah Islamic Port",nameAr:"الهيئة العامة للموانئ",segment:"Government",category:"Convert",totalSAR:105601,invoices:4,contacts:[{name:"JIP",email:"JIP@mawani.gov.sa",phone:"+966920010002"}],entityType:"Government entity",legalName:"الهيئة العامة للموانئ",accountManager:"Abdelrahman",paymentTerms:"Post-paid (govt PO)",contractScope:"Air + hotel for delegations",contractSLA:"Per tender terms",pricing:[{service:"Hotels",value:"+10%",notes:"tender-priced"}],notes:"Tender won. Convert to standing account."},
    {id:"b_riyadhchamber",name:"Riyadh Chamber",nameAr:"الغرفة التجارية بالرياض",segment:"Semi-government",category:"Convert",totalSAR:130298,invoices:8,contacts:[{name:"Alameer",email:"Alameer.s@rdcci.org.sa",phone:"+966555496658"},{name:"Al Hayan",email:"A.hayan@rdcci.org.sa",phone:"+966505285256"}],notes:"Active — formalize."},
    {id:"b_rawiz",name:"Rawiz Investment",nameAr:"شركة راوز للاستثمار",segment:"Corporate",category:"Re-engage",totalSAR:87508,invoices:3,contacts:[{name:"Info",email:"info@rawiz.com.sa",phone:"+966547999565"}],notes:""},
    {id:"b_publicsec",name:"Directorate of Public Security",nameAr:"الأمن العام",segment:"Government",category:"Convert",totalSAR:78000,invoices:1,contacts:[{name:"Info",email:"info@moi.gov.sa",phone:""}],notes:"Tender win — nurture."},
    {id:"b_sunnah",name:"The Sunnah Experience",nameAr:"تجربة السنة",segment:"Religious tourism",category:"Re-engage",totalSAR:70560,invoices:1,contacts:[{name:"Info",email:"info@thesunnahexperience.com",phone:""}],notes:""},
    {id:"b_euroconsult",name:"Euro Consult",nameAr:"يورو كونسلت للاستشارات الهندسية",segment:"Engineering consultancy",category:"Re-engage",totalSAR:60000,invoices:1,contacts:[],notes:""},
    {id:"b_alrajhi",name:"Al-Rajhi Alawla (Events & Conferences)",nameAr:"الراجحي الأولى للمعارض والمؤتمرات",segment:"MICE / Events",category:"Re-engage",totalSAR:47550,invoices:2,contacts:[{name:"Procurement",email:"procurment@saraj.sa",phone:"+966505542666"}],notes:""},
    {id:"b_sfs",name:"Special Forces for Security & Protection",nameAr:"القوات الخاصة للأمن والحماية",segment:"Government",category:"Convert",totalSAR:27600,invoices:1,contacts:[{name:"RL",email:"SSF_RL@moisp.gov.sa",phone:""}],notes:"Tender win."},
    {id:"b_redcrescent",name:"Saudi Red Crescent Authority",nameAr:"هيئة الهلال الأحمر السعودي",segment:"Government",category:"Convert",totalSAR:24955,invoices:1,contacts:[{name:"Office",email:"",phone:"+966112805555"}],notes:"Tender win."},
    {id:"b_iu",name:"Islamic University of Madinah",nameAr:"الجامعة الإسلامية بالمدينة",segment:"Government / Education",category:"Re-engage",totalSAR:24340,invoices:3,contacts:[{name:"PR",email:"Pr@iu.edu.sa",phone:"+966539430472"}],notes:""},
    {id:"b_imsiu",name:"Imam Mohammad Ibn Saud University (IMSIU)",nameAr:"جامعة الإمام محمد بن سعود",segment:"Government / Education",category:"Re-engage",totalSAR:23988,invoices:1,contacts:[{name:"Info",email:"info@imamu.edu.sa",phone:""}],notes:""},
    {id:"b_nobalaa",name:"Nobalaa Senior Management Consulting",nameAr:"مؤسسة نبلاء للاستشارات الإدارية العليا",segment:"Consulting",category:"Convert",totalSAR:1410260,invoices:8,b2c:true,contacts:[{name:"Office",email:"",phone:"+966595173837"}],notes:"B2C-discovered. Large — VERIFY: phone matches an internal Direct contact."},
    {id:"b_coffee",name:"Saudi Coffee Association",nameAr:"جمعية القهوة السعودية",segment:"Association",category:"Convert",totalSAR:88955,invoices:5,b2c:true,contacts:[{name:"Info",email:"info@qasa.coffee",phone:"+966553346684"}],notes:"B2C-discovered."},
    {id:"b_nes",name:"National Electronic Systems",nameAr:"الشركة الوطنية للأنظمة الإلكترونية",segment:"Technology",category:"Convert",totalSAR:89040,invoices:1,b2c:true,contacts:[{name:"Office",email:"",phone:"+966598596616"}],notes:"B2C-discovered."},
    {id:"b_azm",name:"Al-Azm Al-Thunai Est.",nameAr:"مؤسسة العزم الثنائي",segment:"Corporate",category:"Convert",totalSAR:77000,invoices:4,b2c:true,contacts:[{name:"Nasser Dajani",email:"Nasser.m.dajani@gmail.com",phone:"+966546622586"}],notes:"B2C-discovered."},
    {id:"b_tvtc",name:"TVTC — Technical & Vocational Training",nameAr:"المؤسسة العامة للتدريب التقني والمهني",segment:"Government / Training",category:"Convert",totalSAR:23338,invoices:4,b2c:true,contacts:[{name:"Amal",email:"amalab@tvtc.gov.sa",phone:"+966556408080"}],notes:"B2C-discovered. Government."},
    {id:"b_afaq",name:"Afaq Al-Gharaa Sanitary Tools",nameAr:"مؤسسة آفاق الغراء للأدوات الصحية",segment:"Trading (SME)",category:"Re-engage",totalSAR:5876,invoices:24,b2c:true,contacts:[{name:"Eng. Omar",email:"Eng.omar41@yahoo.com",phone:"+966555962295"}],notes:"B2C-discovered. 24 invoices — strong re-engage."},
    {id:"b_tunnels",name:"Saudi Tunnels Contracting",nameAr:"شركة الأنفاق السعودية للمقاولات",segment:"Contracting (SME)",category:"Re-engage",totalSAR:6697,invoices:17,b2c:true,contacts:[{name:"Info",email:"INFO-STCC@TUNNLELS.SA",phone:"+966593405270"}],notes:"B2C-discovered. 17 invoices."},
    {id:"b_majal",name:"Majal Al-Bina Contracting",nameAr:"شركة مجال البناء للمقاولات",segment:"Contracting (SME)",category:"Re-engage",totalSAR:8418,invoices:15,b2c:true,contacts:[{name:"Khaled",email:"khaledmagal20@gmail.com",phone:"+966595502845"}],notes:"B2C-discovered. 15 invoices."},
    {id:"c_acgc",name:"ACGC",segment:"Industrial / Corporate",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Barath Kumar S",email:"b.subramaniam@acgc.com.sa",phone:"+966572262781"}],notes:"🔥 RFP: \"looking for a travel agency to provide a complete Travel Management.\" Highest-intent inbound."},
    {id:"c_sulalaa",name:"Sulalaa Transport",segment:"Transport / Logistics",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Ameer",email:"ameer@sulalaa.com"}],notes:"Wants to explore a B2B collaboration (transport)."},
    {id:"c_zaps",name:"ZAPS Group",segment:"Corporate group",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Shaikh Sulaiman",email:"shaikh.sulaiman@zapsgroup.com",phone:"+966530364278"}],notes:"Wants to onboard Direct KSA for a discount partnership."},
    {id:"c_directfn",name:"DirectFN",segment:"Fintech / Data",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Mohammed Gamea",email:"gamea@directfn.com",phone:"+966504484141"}],notes:"Asked about corporate services for organizations."},
    {id:"c_neom",name:"NEOM",segment:"Giga-project / Government",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Nomtai K. Tukura",email:"nomtai.tukura@neom.com"}],notes:"Schengen visa application service — enterprise account."},
    {id:"c_alshaya",name:"Alshaya Group",segment:"Retail (multinational)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Noel Kim P.",email:"noel.kim@alshaya.com"}],notes:"Staff passport renewal — large corporate travel potential."},
    {id:"c_kemya",name:"SABIC — Al-Jubail (Kemya)",segment:"Petrochemicals (SABIC)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Shaheen",email:"shaheenay@kemya.sabic.com"}],notes:"Partnership / collaboration enquiry."},
    {id:"c_stcbank",name:"STC Bank",segment:"Banking",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Naif Alghwairi",email:"nalghwairi@stcbank.com.sa",phone:"+966541606186"}],notes:"Inbound enquiry — corporate travel prospect."},
    {id:"c_sama",name:"SAMA (Saudi Central Bank)",segment:"Government",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Amal Rasheed",email:"Amalrasheed@sama.gov.sa",phone:"+966505478294"}],notes:"Government enquiry — high-value account."},
    {id:"c_elm",name:"Elm",segment:"Gov-tech",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Saleh Aloraini",email:"Saloraini@elm.sa",phone:"+966582270666"}],notes:"Support / visa enquiry."},
    {id:"c_alfanar",name:"Alfanar",segment:"Industrial / Energy",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Mohamed Elmesalmy",email:"mohamed.elmesalmy@alfanar.com",phone:"+966532284155"}],notes:"Inbound enquiry."},
    {id:"c_walaa",name:"Walaa Insurance",segment:"Insurance",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Fahad Alhusinan",email:"fahad.alhusinan@walaa.com",phone:"+966557088837"}],notes:"Partnership suggestion."},
    {id:"c_honeywell",name:"Honeywell",segment:"Multinational (industrial)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Hesham Hamed",email:"Hesham.Hamed@Honeywell.com",phone:"+966564236733"}],notes:"Corporate visa enquiry — MNC."},
    {id:"c_gevernova",name:"GE Vernova",segment:"Multinational (energy)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Ossama Elfeky",email:"osama.elfkey1@gevernova.com",phone:"+966569880477"}],notes:"Tourism/Italy visa — corporate MNC."},
    {id:"c_abbvie",name:"AbbVie",segment:"Pharma (multinational)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Muhammad Amin",email:"muhammad.amin@abbvie.com"}],notes:"Contacted Riyadh office re visa — MNC account."},
    {id:"c_iff",name:"IFF",segment:"Multinational",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Moustafa Ali",email:"moustafa.ali@iff.com"}],notes:"\"I work in an international company and need a Denmark visa.\""},
    {id:"c_landmark",name:"Landmark Group",segment:"Retail (multinational)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Abdu Yassin",email:"abdu.yassin@landmarkgroup.com"}],notes:"Inbound enquiry."},
    {id:"c_hyatt",name:"Hyatt",segment:"Hospitality",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Mina Azer",email:"mina.azer@hyatt.com"}],notes:"Inbound enquiry — hospitality partner/account."},
    {id:"c_savvy",name:"Savvy Games Group",segment:"PIF entity",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Muhammad Rizwan",email:"msiddiqui@savvygames.com"}],notes:"Urgent Cyprus visa — PIF-owned, strong account."},
    {id:"c_hisense",name:"Hisense",segment:"Multinational (electronics)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Ghada Adel",email:"ghada.adel@hisense.com"}],notes:"\"Reaching out to connect with your team to discuss.\""},
    {id:"c_alrushaid",name:"Al-Rushaid Group",segment:"Industrial group",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Saad Alshahrani",email:"sshahrani@al-rushaid.com",phone:"+966553001085"}],notes:"Inbound enquiry."},
    {id:"c_lazurde",name:"L'azurde",segment:"Manufacturing (jewellery)",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Badr Abdella",email:"badr.abdella@lazurde.com"}],notes:"Inbound enquiry."},
    {id:"c_theeb",name:"Theeb Rent a Car",segment:"Mobility",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Procurement",email:"101126@theeb.sa"}],notes:"Inbound enquiry."},
    {id:"c_zamil",name:"Zamil",segment:"Industrial group",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"ER Manager",email:"er.manager@zamilco.com"}],notes:"Inbound enquiry."},
    {id:"c_alj",name:"Abdul Latif Jameel (ALJ)",segment:"Conglomerate",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"Saad HRM",email:"Saadahrm@alj.com"}],notes:"Inbound enquiry — major group."},
    {id:"c_kafalah",name:"Kafalah Program",segment:"Government",category:"Convert",source:"Contact form",status:"New",contacts:[{name:"D. Ghamdi",email:"d.ghamdi@kafalah.gov.sa"}],notes:"Government enquiry."},
    {id:"c_jeddahexpo",name:"Jeddah Int'l Travel Exhibition (4M)",segment:"MICE / Events",category:"Partner",source:"Conferences",status:"New",contacts:[{name:"Sheikh Hafeez",email:"sheikh.h@4m.com.sa",phone:"+966568059954"}],notes:"Invite to the 14th Jeddah International Travel exhibition — event/conference lead."},
    {id:"c_ideaevents",name:"IDEA Events",segment:"MICE / Events",category:"Partner",source:"Conferences",status:"New",contacts:[{name:"Manal",email:"sales1@ideaevents.net",phone:"+966599062772"}],notes:"Events company (10+ yrs) — partnership intro."},
    {id:"c_qsexpo",name:"QS-Expo",segment:"MICE / Events",category:"Partner",source:"Conferences",status:"New",contacts:[{name:"Song Jia",email:"expo@qs-expo.com"}],notes:"Invitation to participate in an expo."},
    {id:"c_modernstruct",name:"Modern Structure",segment:"Event management (Riyadh)",category:"Partner",source:"Conferences",status:"New",contacts:[{name:"Aml Ali",email:"info@modernstructuresa.com"}],notes:"Riyadh event management company — interested in working together."},
    {id:"c_boston",name:"Boston English Center",segment:"Study-abroad partner",category:"Partner",source:"Contact form",status:"New",contacts:[{name:"Hicham",email:"partnership@bostonenglishcenter.com"}],notes:"Study-abroad partnership — relevant to BD study-abroad line."},
    {id:"c_bctravel",name:"BC Travel",segment:"Travel sub-agent",category:"Partner",source:"Contact form",status:"New",contacts:[{name:"Saeed",email:"Saeed@bctravell.com",phone:"+966500990414"}],notes:"Asked specifically about our B2B service."},
    {id:"c_travelyalla",name:"Travel Yalla (Egypt DMC)",segment:"DMC partner",category:"Partner",source:"Contact form",status:"New",contacts:[{name:"Mariam Eskander",email:"incoming@travelyalla.com"}],notes:"Wants to be our DMC in Egypt."}
  ],
  vendors:[
  ...
  requests:[
    {id:"r1",client:"Mawani — Jeddah Islamic Port",service:"Hotels",detail:"Tender delegation — 18 rooms, Jeddah, 2 nights",stage:"New",owner:"Abdelrahman",priority:"Urgent",createdAt:Date.now()-1.2*3600e3,supplier:"",pnr:"",sell:0,notes:""},
    {id:"r2",client:"MDD — Smart Madad IT",service:"Flights",detail:"3 pax RUH→LHR business class, 12–18 Jun",stage:"Quoting",owner:"Abdelrahman",priority:"High",createdAt:Date.now()-3*3600e3,supplier:"Amadeus",pnr:"",sell:0,notes:""},
    {id:"r3",client:"Riyadh Chamber",service:"Group / MICE",detail:"20 rooms + meeting hall, conference",stage:"Awaiting client",owner:"Raad",priority:"Normal",createdAt:Date.now()-30*3600e3,supplier:"RateHawk",pnr:"",sell:0,notes:"Quote sent, awaiting PO"},
    {id:"r4",client:"Bayswater (student)",service:"Transfer / Chauffeur",detail:"Student RUH→MAN flight + airport chauffeur",stage:"Ticketed",owner:"Kareem",priority:"Normal",createdAt:Date.now()-50*3600e3,supplier:"Travel Fusion",pnr:"X4K9PQ",sell:4200,cost:3600,notes:""},
    {id:"r5",client:"Benchmark for Conferences",service:"Hotels",detail:"Speaker accommodation, 4 rooms Riyadh",stage:"Delivered",owner:"Abdelrahman",priority:"Normal",createdAt:Date.now()-90*3600e3,supplier:"WebBeds",pnr:"HCN-602966",sell:9800,cost:8200,notes:"Vouchers delivered"}
  ],
  airlines:[
