...
(function(){
  ...
  function addTabs(v){
    ...
    /* 2026-09-21 (fire #166): a class, so the share-view layer can take this off a view-only link —
       the file it writes carries every lead's owner, next action and contact details. */
    ex.className='v33-export-view';
